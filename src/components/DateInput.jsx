    ...
    <>
      <div className="flex flex-col gap-10">
        <div className="flex gap-2">
          <div>
            <label className="block" htmlFor={id.startMonth}>
              Start Month
            </label>
          ...
          <div>
            <label className="block" htmlFor={id.startYear}>
              Start Year
            </label>
            <select
              className="p-2  focus:border-yellow-500 focus:outline focus:outline-1 focus:outline-yellow-500 focus:bg-slate-100 border border-slate-300 rounded-md border-1"
        ...
        <div className="flex gap-2">
          <div>
            <label className="block" htmlFor={id.endMonth}>
              End Month
            </label>
            <select
              className="p-2  focus:border-yellow-500 focus:outline focus:outline-1 focus:outline-yellow-500 focus:bg-slate-100 border border-slate-300 rounded-md border-1"
          ...
          <div>
            <label className="block" htmlFor={id.endYear}>
              End Year
            </label>
            <select
              className="p-2  focus:border-yellow-500 focus:outline focus:outline-1 focus:outline-yellow-500 focus:bg-slate-100 border border-slate-300 rounded-md border-1"
